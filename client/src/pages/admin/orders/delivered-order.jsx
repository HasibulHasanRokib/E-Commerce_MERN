...
const DeliveredOrder = () => {
  ...
  const delivered = data.filter(data => data.status === 'delivered');
  const handlePrint=()=>{
    window.print()
  }
            ...
            return (
              <div className=" bg-white p-4 border shadow-sm" key={items?._id}>
                ...
                {items?.status === "delivered" ? null : (
                  <button className="bg-sky-800 py-2 border shadow-sm rounded-md text-white font-bold w-full mt-5">
