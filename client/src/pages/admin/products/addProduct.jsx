  ...
  return (
    <div>
      ...
      <form className="grid grid-cols-2 gap-10" onSubmit={handleSubmit}>
        ...
        <label >Title:</label>
        <input onChange={handleChange} className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="Enter product title" type="text" name="title" id="title" />
        
        <label className="mt-3">Brand:</label>
        <input onChange={handleChange}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="Enter Brand Name"  type="text" name="brand" id="brand" />

        <label className="mt-3">Regular Price(Tk):</label>
        <input onChange={handleChange} className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="0"  type="number" name="regularPrice" id="regularPrice" />

        <label className="mt-3">Discount Percentage:</label>
        <input onChange={handleChange} className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="0%"  type="number" name="discountPercentage" id="discountPercentage"  />

     
        <label className="mt-3">Stock:</label>
        <input onChange={handleChange}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="0"  type="number" name="stock" id="stock"  />
        
        <label className="mt-3">Category:</label>
        <input onChange={handleChange} className="px-3 py-2 mt-1 outline-lime-50 rounded-md" type="text" name="category" id="category" placeholder="Category" />
     

        <label className="mt-3">Description:</label>
        <textarea onChange={handleChange}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md" placeholder="Enter Description"  name="description" id="description" cols="10" rows="5"></textarea>
        </div>
