...
const handleUpdate = (e)=>{
  ...
  return (
    <div>
      <h2 className="font-bold text-2xl ">Update Portfolio</h2>
     
        <form className="grid grid-cols-2 gap-10" onSubmit={handleUpdate}>
        <div className="flex flex-1 flex-col max-w-lg my-3">
        <label >Title:</label>
        <input onChange={handleChange} value={formData.title} className="px-3 py-2 mt-1 outline-lime-50 rounded-md" type="text" name="title" id="title" />
        
        <label className="mt-3">Location:</label>
        <input onChange={handleChange} value={formData.location}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md"  type="text" name="location" id="location" />

        <label className="mt-3">Type:</label>
        <input onChange={handleChange} value={formData.type} className="px-3 py-2 mt-1 outline-lime-50 rounded-md"  type="text" name="type" id="type" />

        <label className="mt-3">Architect:</label>
        <input onChange={handleChange} value={formData.architect} className="px-3 py-2 mt-1 outline-lime-50 rounded-md"  type="text" name="architect" id="architect"  />

        <label className="mt-3">Photography:</label>
        <input onChange={handleChange} value={formData.photography}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md"  type="text" name="photography" id="photography"  />
        
        <label className="mt-3">Description:</label>
        <textarea onChange={handleChange} value={formData.description}  className="px-3 py-2 mt-1 outline-lime-50 rounded-md"  name="description" id="description" cols="10" rows="5"></textarea>
        </div>
